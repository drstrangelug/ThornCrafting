...
local function InitializeDatabase()
    ...
    local sources = {
        { data = ns.AlchemyRecipes,       prof = ProfessionsList[3].id },
        { data = ns.BlacksmithingRecipes, prof = ProfessionsList[1].id },
        { data = ns.CookingRecipes,       prof = ProfessionsList[8].id },
        { data = ns.EnchantingRecipes,    prof = ProfessionsList[7].id },
        { data = ns.EngineeringRecipes,   prof = ProfessionsList[2].id },
        { data = ns.FirstAidRecipes,      prof = ProfessionsList[10].id },
        { data = ns.JewelCraftingRecipes, prof = ProfessionsList[6].id },
        { data = ns.LeatherWorkingRecipes,prof = ProfessionsList[4].id },
        { data = ns.MiningRecipes,        prof = ProfessionsList[9].id },
        { data = ns.TailoringRecipes,     prof = ProfessionsList[5].id }
    }
